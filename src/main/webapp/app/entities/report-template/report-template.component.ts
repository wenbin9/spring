...
export class ReportTemplateComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reportTemplateService
      ...
      .subscribe(
        (res: HttpResponse<IReportTemplate[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInReportTemplates(): void {
    this.eventSubscriber = this.eventManager.subscribe('reportTemplateListModification', () => this.loadPage());
  }
